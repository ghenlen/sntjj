...
public class SystemService extends BaseService implements InitializingBean {
	 ...
	 * @return
	 */
	public User getByUserGuid(String loginName) {
		return userDao.getByUserGuid(loginName);
	}
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public List<IndustryCodeTree> findIndustryCodeListByUser(String userId){
		return userDao.findIndustryCodeListByUser(userId);
	}
	///////////////// Synchronized to the Activiti end //////////////////
	@Transactional(readOnly = false)
	public void updateIndustryCode(User user) {
		userDao.deleteUserIndustryCode(user);
		if (user.getIndustryCodeList().size() > 0){
			userDao.insertUserIndustryCode(user);
		}					
	}
}
